...
### Nous avons atteint 600 étoiles ! Merci à tous pour votre soutien à Agent! Il nous reste encore un long chemin à parcourir, mais le départ est formidable. Agent! est né le 1er avril 2026 avec notre propre technologie, développée depuis 2000 et entre 2023 et 2026.
...
Agent! est une app 100 % native Swift 6.2 / SwiftUI qui relie **21 fournisseurs de LLM** — Claude, Codex, OpenAI, Gemini, Grok, Mistral, Mistral Vibe, DeepSeek, Hugging Face, Z.ai, BigModel, Alibaba DashScope, Qwen, Qwen Code, MiniMax, OpenRouter, Requesty, A2Agent, OrcaRouter, Ollama (cloud et local), vLLM et LM Studio — plus **Apple Intelligence** sur l'appareil — à une boucle de tâches autonome qui *agit vraiment* : elle lit votre code, corrige le bug, compile le projet Xcode, committe le diff, pilote n'importe quelle app Mac via l'API d'Accessibilité, exécute des commandes shell en votre nom ou en root, vous envoie les résultats par iMessage et répond à un *« Agent! »* prononcé à voix haute.
...
| **Alibaba DashScope** (Model Studio / QwenCloud paiement à l'usage) | Bon marché | Qwen 3.8 via DashScope |
...
>
> « AgentiLoop Agent! » et le logo AgentiLoop Agent! sont des marques déposées de AgentiLoop.ai, une société de Logos InkPen LLC. L'utilisation de ces marques nécessite une autorisation écrite préalable. La licence MIT ci-dessous accorde des droits uniquement sur le code source — elle **n'accorde aucun** droit de marque.
>
